...
# Constants
DIFFICULTY_SETTINGS = {
    "easy": {"size_x": 8, "size_y": 8, "mine_density": 0.1},
    "medium": {"size_x": 10, "size_y": 10, "mine_density": 0.15},
    "hard": {"size_x": 12, "size_y": 12, "mine_density": 0.2}
}
...
class Minesweeper:
    def __init__(self, tk_root, difficulty):
        ...
        self.labels = {
            "time": tkinter.Label(self.frame, text="00:00:00"),
            "mines": tkinter.Label(self.frame, text="Mines: 0"),
            "flags": tkinter.Label(self.frame, text="Flags: 0")
        }
    ...
    def setup(self):
        if self.difficulty == "easy":
            ...
            size_x, size_y = settings["size_x"], settings["size_y"]
    ...
    def refresh_labels(self):
        self.labels["flags"].config(text=f"Flags: {Minesweeper.flag_count}")
...
def main():
    ...
    minesweeper = Minesweeper(tk_root=window, difficulty="medium")
    window.mainloop()
